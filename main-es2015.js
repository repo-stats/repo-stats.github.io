...
/* harmony import */ var _packagist_packagist_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./packagist/packagist.component */ "./src/app/packagist/packagist.component.ts");
...
/* harmony import */ var _packagist_packagist_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./packagist/packagist.component */ "./src/app/packagist/packagist.component.ts");
/* harmony import */ var _packagist_packagist_service__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./packagist/packagist.service */ "./src/app/packagist/packagist.service.ts");
...
AppModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({ factory: function AppModule_Factory(t) { return new (t || AppModule)(); }, providers: [
        _packagist_packagist_service__WEBPACK_IMPORTED_MODULE_14__["PackagistService"],
    ], imports: [[
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](AppModule, { declarations: [_app_component__WEBPACK_IMPORTED_MODULE_12__["AppComponent"],
        _packagist_packagist_component__WEBPACK_IMPORTED_MODULE_13__["PackagistComponent"]], imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"],
        _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_4__["BrowserAnimationsModule"],
        _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormsModule"],
        _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClientModule"],
        _angular_material_datepicker__WEBPACK_IMPORTED_MODULE_7__["MatDatepickerModule"],
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](AppModule, [{
        ...
        args: [{
                declarations: [
                    ...
                    _packagist_packagist_component__WEBPACK_IMPORTED_MODULE_13__["PackagistComponent"],
                ],
                imports: [
                    _angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"],
                    _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_4__["BrowserAnimationsModule"],
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PackagistComponent", function() { return PackagistComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
/* harmony import */ var _packagist_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./packagist.service */ "./src/app/packagist/packagist.service.ts");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/__ivy_ngcc__/fesm2015/forms.js");
...
function PackagistComponent_mat_option_19_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-option", 11);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} if (rf & 2) {
    const possibleGrouping_r5 = ctx.$implicit;
...
function PackagistComponent_div_23_Template(rf, ctx) { if (rf & 1) {
...
function PackagistComponent_table_24_tr_10_Template(rf, ctx) { if (rf & 1) {
...
function PackagistComponent_table_24_Template(rf, ctx) { if (rf & 1) {
...
class PackagistComponent {
    constructor(packagistService) {
    ...
    check() {
        ...
        this.packagistService.getPackageVersions(this.packageName).subscribe((versions) => {
            ...
            Promise.all(versionsPromises)
                .then((versionsDownloads) => {
                this.totalDownloads = versionsDownloads.reduce((previous, item) => (previous + item.downloads), 0);
                const versionsMap = versionsDownloads.reduce((container, item) => {
...
PackagistComponent.ɵfac = function PackagistComponent_Factory(t) { return new (t || PackagistComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_packagist_service__WEBPACK_IMPORTED_MODULE_1__["PackagistService"])); };
PackagistComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: PackagistComponent, selectors: [["app-packagist"]], decls: 25, vars: 11, consts: [["matInput", "", "placeholder", "Provide package name", "name", "packageName", 3, "ngModel", "ngModelChange"], ["matInput", "", "placeholder", "Choose a start date", "name", "fromDate", 3, "matDatepicker", "ngModel", "ngModelChange"], ["matSuffix", "", 3, "for"], ["picker_from", ""], ["matInput", "", "placeholder", "Choose a end date", "name", "toDate", 3, "matDatepicker", "ngModel", "ngModelChange"], ["picker_to", ""], [3, "value", "valueChange"], [3, "value", 4, "ngFor", "ngForOf"], ["mat-raised-button", "", 3, "click"], ["class", "progress", 4, "ngIf"], [4, "ngIf"], [3, "value"], [1, "progress"], [4, "ngFor", "ngForOf"]], template: function PackagistComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function PackagistComponent_Template_input_ngModelChange_4_listener($event) { return ctx.packageName = $event; });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](5, "mat-form-field");
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](6, "input", 1);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function PackagistComponent_Template_input_ngModelChange_6_listener($event) { return ctx.fromDate = $event; });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function PackagistComponent_Template_input_ngModelChange_11_listener($event) { return ctx.toDate = $event; });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("valueChange", function PackagistComponent_Template_mat_select_valueChange_18_listener($event) { return ctx.grouping = $event; });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function PackagistComponent_Template_button_click_21_listener() { return ctx.check(); });
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](PackagistComponent, [{
    ...
    }], function () { return [{ type: _packagist_service__WEBPACK_IMPORTED_MODULE_1__["PackagistService"] }]; }, null); })();
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PackagistService", function() { return PackagistService; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
...
class PackagistService {
    ...
    getPackageVersions(name) {
        return this.http.get(`https://packagist.org/p/${name}.json`).map((data) => {
            return Object.keys(data.packages[name]);
        });
    }
    getPackageVersionDownloads(name, version, from, to) {
        return this.http.get(`https://packagist.org/packages/${name}/stats/${version}.json?average=daily&from=${from}&to=${to}`).map((data) => {
...
PackagistService.ɵfac = function PackagistService_Factory(t) { return new (t || PackagistService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"])); };
PackagistService.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({ token: PackagistService, factory: PackagistService.ɵfac });
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](PackagistService, [{
...
module.exports = __webpack_require__(/*! /home/d.ruminski/github/repo-stats.github.io/src/main.ts */"./src/main.ts");
